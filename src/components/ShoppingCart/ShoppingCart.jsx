...
const ShoppingCart = () => {
  ...
  const userId = useSelector((state) => state.auth?.userId || null, (prev, next) => prev === next);
  const cartItems = useSelector((state) => state.cart?.items || [], (prev, next) => prev.length === next.length);
