...
function UploadFile() {
 const svgOK = <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-patch-check" viewBox="0 0 16 16">
...
const svgBad = <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
<path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8z"/>
 ...
 const handleFile = (event) => {
    ...
    return (
        <div>
            <input type="file" onChange={handleFile}  className=''/>
            {responseOk >= 200 ? <>{svgOK}</> : <>{svgBad}</>}
        </div>
        );
}
