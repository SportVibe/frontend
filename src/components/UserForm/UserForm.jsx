  ...
  const handleSubmt = async (event) => {
    ...
    try {
      ...
      if (newUsers.firstName === '' &&
        ...
        Swal.fire("Falta el primer nombre. Por favor, completa el campo correspondiente.");
      ...
      //   alert('Direccion erronea, por favor corrige el campo correspondiente')
        ...
        Swal.fire("Contraseña erronea, por favor corrige el campo correspondiente");
      ...
      <div className="contenedorUF">
        ...
        <div className="contenedor1">
          ...
          <div className="contenedor2">
            ...
            <input className="input" type="number" name="phoneNumber" value={newUsers.phoneNumber} onChange={handleChange} />
          </div>
          ...
          <div className="contenedor2">
            ...
            <input className="input" type="number" name="zipCode" value={newUsers.zipCode} onChange={handleChange} />
          </div>
